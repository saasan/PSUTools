...
namespace PSUTools
{
    class Window
    {
        ...
        public static void AddSystemButton(IntPtr hWnd)
        {
            ...
            style |= (WindowStyleFlags.WS_SYSMENU |
                WindowStyleFlags.WS_MINIMIZEBOX |
                WindowStyleFlags.WS_MAXIMIZEBOX);
        ...
        public static void AddSystemButton(string className)
        {
            ...
            if (hWnd == IntPtr.Zero)
            {
                throw new WindowNotFoundException(Properties.Resources.WindowNotFound);
            }
        ...
        public static Point GetPosition(IntPtr hWnd)
        {
            ...
            {
                throw new WindowOperationException(Properties.Resources.WindowOperationFailed);
            }
        ...
        public void UpdateHandle()
        {
            ...
            if (hWnd == IntPtr.Zero) throw new WindowNotFoundException(Properties.Resources.WindowNotFound);
        }
    ...
    class WindowOperationException : ApplicationException
    {
        ...
        public WindowOperationException(string message)
            : base(message)
        {
        }
